    ...
    override fun createPacket(
        ...
        packetObj.actions.forEach { infoUpdateAction ->
            when (infoUpdateAction) {
                ...
                InfoUpdateAction.UPDATE_GAME_MODE -> {
