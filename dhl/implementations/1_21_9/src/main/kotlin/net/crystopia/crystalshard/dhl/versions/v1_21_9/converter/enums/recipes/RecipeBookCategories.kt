package net.crystopia.crystalshard.dhl.versions.v1_21_9.converter.enums.recipes
...
enum class RecipeBookCategories(val category: RecipeBookCategory) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.recipes.RecipeBookCategories): net.crystopia.crystalshard.dhl.versions.v1_21_9.converter.enums.recipes.RecipeBookCategories {
            return net.crystopia.crystalshard.dhl.versions.v1_21_9.converter.enums.recipes.RecipeBookCategories.valueOf(
                type.name
            )
        }
    }
