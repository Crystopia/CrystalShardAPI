...
import net.crystopia.crystalshard.dhl.versions.v1_21_9.converter.data.particles.build
import net.crystopia.crystalshard.dhl.versions.v1_21_9.converter.enums.particles.ParticleType
...
class Shard_ClientboundLevelParticlesPacket : IClientPacket<ClientboundLevelParticlesPacketData> {
    ...
    override fun createPacket(
        ...
        val particleData =
            ...
            ) else particle as ParticleOptions
