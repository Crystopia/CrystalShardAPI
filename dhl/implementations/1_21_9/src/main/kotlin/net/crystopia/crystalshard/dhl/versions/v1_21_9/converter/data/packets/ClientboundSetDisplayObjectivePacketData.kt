...
import net.crystopia.crystalshard.dhl.versions.v1_21_9.converter.enums.scoreboard.ObjectiveCriteria
...
fun ClientboundSetDisplayObjectivePacketData.build(): Objective {
    ...
    return Objective(
        ...
        net.crystopia.crystalshard.dhl.versions.v1_21_9.converter.enums.scoreboard.RenderType.convert(displayData.renderType).id,
