package net.crystopia.crystalshard.dhl.versions.v1_21_1.converter.enums.teams
...
enum class NameTagVisibility(val id: Team.Visibility) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.teams.NameTagVisibility): NameTagVisibility {
            return NameTagVisibility.valueOf(
                type.name
            )
        }
    }
