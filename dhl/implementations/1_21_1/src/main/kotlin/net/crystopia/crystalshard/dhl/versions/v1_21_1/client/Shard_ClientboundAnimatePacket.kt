...
class Shard_ClientboundAnimatePacket :
    net.crystopia.crystalshard.dhl.shared.interfaces.packets.IPacket<net.crystopia.crystalshard.dhl.shared.data.packets.client.ClientboundAnimatePacketData> {
