package net.crystopia.crystalshard.dhl.versions.v1_21_1.converter.enums.scoreboard
...
enum class ObjectiveCriteria(val id: net.minecraft.world.scores.criteria.ObjectiveCriteria) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.scoreboard.ObjectiveCriteria): ObjectiveCriteria {
