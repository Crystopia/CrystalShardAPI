package net.crystopia.crystalshard.dhl.versions.v1_21_1.converter.enums.game
...
enum class GameEventType(val id : ClientboundGameEventPacket.Type) {
    ...
    ARROW_HIT_PLAYER(ClientboundGameEventPacket.ARROW_HIT_PLAYER),
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.game.GameEventType): GameEventType {
            return GameEventType.valueOf(
                type.name
            )
        }
    }
