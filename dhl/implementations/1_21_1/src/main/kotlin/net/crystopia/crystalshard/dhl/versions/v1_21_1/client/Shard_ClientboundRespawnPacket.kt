...
import net.crystopia.crystalshard.dhl.versions.v1_21_1.converter.enums.player.GameMode
    ...
    override fun createPacket(
        ...
        return ClientboundRespawnPacket(
            CommonPlayerSpawnInfo(
                ...
                mcWorld.dimension(),
                (mcWorld.world as ServerLevel).seed,
                ...
                Optional.of(
                    GlobalPos(
                        ...
                        BlockPos(
                            packetObj.deathLocation.x.toInt(),
                            packetObj.deathLocation.y.toInt(),
                            packetObj.deathLocation.z.toInt()
                        )
                    )
                ),
