package net.crystopia.crystalshard.dhl.versions.v1_21_11.converter.enums.packets
...
internal enum class InfoUpdateAction(val action: ClientboundPlayerInfoUpdatePacket.Action) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.packets.InfoUpdateAction): InfoUpdateAction {
