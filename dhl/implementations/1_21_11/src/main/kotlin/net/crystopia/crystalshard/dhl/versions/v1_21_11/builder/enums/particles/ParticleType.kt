package net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.particles
...
enum class ParticleType(val id : ParticleType<*>) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.particles.ParticleType): net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.particles.ParticleType {
            return net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.particles.ParticleType.valueOf(
                type.name
            )
        }
    }
