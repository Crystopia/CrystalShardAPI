package net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.data.particles
...
fun net.crystopia.crystalshard.dhl.shared.data.particles.BlockParticleOption.build(): BlockParticleOption {
    return BlockParticleOption(
        net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.particles.ParticleType.convert(type).id as net.minecraft.core.particles.ParticleType<BlockParticleOption>,
...
fun net.crystopia.crystalshard.dhl.shared.data.particles.ColorParticleOption.build(): ColorParticleOption {
    return ColorParticleOption.create(
        net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.particles.ParticleType.convert(type).id as net.minecraft.core.particles.ParticleType<ColorParticleOption>,
        color
    )
}
...
fun net.crystopia.crystalshard.dhl.shared.data.particles.ItemParticleOption.build(): ItemParticleOption {
    return ItemParticleOption(
        net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.particles.ParticleType.convert(type) as net.minecraft.core.particles.ParticleType<ItemParticleOption>,
        item
    )
}
...
fun net.crystopia.crystalshard.dhl.shared.data.particles.PowerParticleOption.build(): PowerParticleOption {
    return PowerParticleOption.create(
        net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.particles.ParticleType.convert(type).id as net.minecraft.core.particles.ParticleType<PowerParticleOption>,
        power
    )
}
...
fun net.crystopia.crystalshard.dhl.shared.data.particles.SpellParticleOption.build(): SpellParticleOption {
    return SpellParticleOption.create(
        net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.particles.ParticleType.convert(type).id as net.minecraft.core.particles.ParticleType<SpellParticleOption>,
        color,
        power
    )
}
