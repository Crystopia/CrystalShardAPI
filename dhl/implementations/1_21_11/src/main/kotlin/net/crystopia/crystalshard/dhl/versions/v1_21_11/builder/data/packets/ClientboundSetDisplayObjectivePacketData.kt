...
import net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.scoreboard.ObjectiveCriteria
...
fun ClientboundSetDisplayObjectivePacketData.build(): Objective {
    ...
    return Objective(
        ...
        net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.scoreboard.RenderType.convert(displayData.renderType).id,
