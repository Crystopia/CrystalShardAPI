package net.crystopia.crystalshard.dhl.versions.v1_21_11.converter.data.dialog.buttons
...
fun net.crystopia.crystalshard.dhl.shared.data.dialog.buttons.ActionButton.build(): net.minecraft.server.dialog.ActionButton {
