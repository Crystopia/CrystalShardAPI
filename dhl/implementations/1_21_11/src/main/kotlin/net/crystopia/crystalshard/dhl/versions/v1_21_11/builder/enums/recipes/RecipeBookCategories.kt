package net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.recipes
...
enum class RecipeBookCategories(val category: RecipeBookCategory) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.recipes.RecipeBookCategories): net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.recipes.RecipeBookCategories {
            return net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.recipes.RecipeBookCategories.valueOf(
                type.name
            )
        }
    }
