package net.crystopia.crystalshard.dhl.versions.v1_21_11.converter.enums.maps
...
enum class MapDecorationType(val id : Holder<net.minecraft.world.level.saveddata.maps.MapDecorationType>) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.maps.MapDecorationType): MapDecorationType {
