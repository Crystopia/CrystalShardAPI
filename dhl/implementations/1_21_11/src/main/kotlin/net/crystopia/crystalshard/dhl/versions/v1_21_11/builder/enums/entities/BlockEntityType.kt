package net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.entities
...
enum class BlockEntityType(val type: BlockEntityType<*>) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.entities.BlockEntityType): net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.entities.BlockEntityType {
            return net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.enums.entities.BlockEntityType.valueOf(
                type.name
            )
        }
    }
