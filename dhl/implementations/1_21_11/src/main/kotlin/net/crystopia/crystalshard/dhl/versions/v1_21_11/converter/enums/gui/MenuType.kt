package net.crystopia.crystalshard.dhl.versions.v1_21_11.converter.enums.gui
...
internal enum class MenuType(val type: MenuType<*>) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.gui.MenuType): net.crystopia.crystalshard.dhl.versions.v1_21_11.converter.enums.gui.MenuType {
