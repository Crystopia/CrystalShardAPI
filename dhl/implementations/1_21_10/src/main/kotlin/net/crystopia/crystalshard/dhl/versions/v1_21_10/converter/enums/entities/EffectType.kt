...
enum class EffectType(val id : Holder<MobEffect>) {
    ...
    INSTANT_HEALTH(MobEffects.INSTANT_HEALTH),
    INSTANT_DAMAGE(MobEffects.INSTANT_DAMAGE),
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.entities.EffectType): EffectType {
            return valueOf(
                type.name
            )
        }
