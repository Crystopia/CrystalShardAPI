...
import net.crystopia.crystalshard.dhl.versions.v1_21_10.converter.data.particles.build
...
class Shard_ClientboundLevelParticlesPacket : IPacket<ClientboundLevelParticlesPacketData> {
    ...
    override fun createPacket(
        ...
        val particleData =
            if (packetObj.particle.options == null) ParticleType.convert(packetObj.particle.particle) else particle as net.minecraft.core.particles.ParticleOptions

        return ClientboundLevelParticlesPacket(
            particleData as net.minecraft.core.particles.ParticleOptions,
