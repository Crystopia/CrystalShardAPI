package net.crystopia.crystalshard.dhl.versions.v1_21_10.converter.enums.particles
...
enum class ParticleType(val id : ParticleType<*>) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.particles.ParticleType): ParticleType<*> {
            return valueOf(
                type.name
            ).id
        }
