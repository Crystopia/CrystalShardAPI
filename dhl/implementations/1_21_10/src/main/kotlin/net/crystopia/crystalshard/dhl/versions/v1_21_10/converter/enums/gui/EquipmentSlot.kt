package net.crystopia.crystalshard.dhl.versions.v1_21_10.converter.enums.gui
...
internal enum class EquipmentSlot(val type: net.minecraft.world.entity.EquipmentSlot) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.dhl.shared.enums.gui.EquipmentSlot): EquipmentSlot {
