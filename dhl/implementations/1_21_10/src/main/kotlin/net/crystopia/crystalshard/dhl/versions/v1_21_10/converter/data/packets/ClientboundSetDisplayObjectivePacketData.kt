...
import net.crystopia.crystalshard.dhl.versions.v1_21_10.converter.enums.scoreboard.ObjectiveCriteria
import net.crystopia.crystalshard.dhl.versions.v1_21_10.converter.enums.scoreboard.RenderType
...
fun ClientboundSetDisplayObjectivePacketData.build(): Objective {
    val data = when (displayData.numberFormat) {
        NumberFormat.FIXED -> {
            val scoreboard = (displayData.format as FixedFormat).value
