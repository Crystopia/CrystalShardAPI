package net.crystopia.crystalshard.dhl.versions.v1_21_10.converter.data.dialog
...
import net.crystopia.crystalshard.dhl.versions.v1_21_10.converter.data.dialog.input.build
import net.crystopia.crystalshard.dhl.versions.v1_21_10.converter.enums.dialog.DialogAction
...
internal fun CommonDialogData.build(): net.minecraft.server.dialog.CommonDialogData {
    ...
    inputs.forEach { input ->
        ...
        val inputData = when (input) {
            is DialogBooleanInput -> {
                input.build()
            }

            is DialogNumberRangeInput -> {
                input.build()
            }

            is DialogSingleOptionInput -> {
                input.build()
            }
