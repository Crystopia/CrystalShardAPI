package net.crystopia.crystalshard.paper.util.smart

import net.crystopia.crystalshard.paper.util.extension.onClick
import net.crystopia.crystalshard.paper.util.extension.onClose
import net.crystopia.crystalshard.paper.util.extension.onSlotClick
