...
import net.crystopia.crystalshard.paper.core.displays.PBlockDisplay
import net.crystopia.crystalshard.paper.core.displays.PItemDisplay
...
import net.crystopia.crystalshard.paper.shared.interfaces.npcs.INpc
import net.crystopia.crystalshard.paper.versions.v1_21_10.general.EntityBuilder
...
object EntityFactory {
    ...
    fun <T : net.crystopia.crystalshard.paper.shared.interfaces.npcs.INpc> createNpc(
        location: Location, key: NamespacedKey, name: String, callback: T.() -> Unit
    ): net.crystopia.crystalshard.paper.shared.interfaces.npcs.INpc {
        ...
        val serverplayer = when (ServerUtil.currentVersion()) {
            ...
            ServerVersion.v1_21_1 -> {
                net.crystopia.crystalshard.paper.versions.v1_21_1.general.EntityBuilder.createServerPlayer(
                    location.world, key, name
                )
            }
    ...
    fun <T : IDisplay> createDisPlayEntity(
        ...
        val displayEntity = when (ServerUtil.currentVersion()) {
            ...
            ServerVersion.v1_21_1 -> {
                net.crystopia.crystalshard.paper.versions.v1_21_1.general.EntityBuilder.createDisplayEntity(
                    type, location
                )
            }
