...
internal enum class EquipmentSlot(val type: net.minecraft.world.entity.EquipmentSlot) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.paper.dhl.shared.enums.gui.EquipmentSlot): EquipmentSlot {
