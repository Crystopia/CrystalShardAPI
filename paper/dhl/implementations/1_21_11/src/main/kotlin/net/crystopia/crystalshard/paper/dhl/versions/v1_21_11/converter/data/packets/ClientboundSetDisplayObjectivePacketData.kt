package net.crystopia.crystalshard.paper.dhl.versions.v1_21_11.converter.data.packets
...
import net.crystopia.crystalshard.paper.dhl.versions.v1_21_11.converter.enums.scoreboard.ObjectiveCriteria
...
fun ClientboundSetDisplayObjectivePacketData.build(): Objective {
    ...
    return Objective(
        ...
        net.crystopia.crystalshard.paper.dhl.versions.v1_21_11.converter.enums.scoreboard.RenderType.convert(displayData.renderType).id,
