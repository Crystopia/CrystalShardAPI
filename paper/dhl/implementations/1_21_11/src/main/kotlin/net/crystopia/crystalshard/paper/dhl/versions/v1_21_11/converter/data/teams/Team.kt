package net.crystopia.crystalshard.paper.dhl.versions.v1_21_11.converter.data.teams
...
import net.crystopia.crystalshard.paper.dhl.versions.v1_21_11.converter.enums.teams.CollisionRule
import net.crystopia.crystalshard.paper.dhl.versions.v1_21_11.converter.enums.teams.NameTagVisibility
...
fun Team.build(): PlayerTeam {
    ...
    team.setPlayerPrefix(PaperAdventure.asVanilla(teamPrefix))
    team.setPlayerSuffix(PaperAdventure.asVanilla(teamSuffix))
