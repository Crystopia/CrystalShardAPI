package net.crystopia.crystalshard.paper.dhl.versions.v1_21_11.converter.enums.particles
...
enum class ParticleType(val id : ParticleType<*>) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.paper.dhl.shared.enums.particles.ParticleType): net.crystopia.crystalshard.paper.dhl.versions.v1_21_11.converter.enums.particles.ParticleType {
            return net.crystopia.crystalshard.paper.dhl.versions.v1_21_11.converter.enums.particles.ParticleType.valueOf(
                type.name
            )
        }
    }
