package net.crystopia.crystalshard.paper.dhl.versions.v1_21_9.converter.enums.entities
...
enum class BlockEntityType(val type: BlockEntityType<*>) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.paper.dhl.shared.enums.entities.BlockEntityType): net.crystopia.crystalshard.paper.dhl.versions.v1_21_9.converter.enums.entities.BlockEntityType {
            return net.crystopia.crystalshard.paper.dhl.versions.v1_21_9.converter.enums.entities.BlockEntityType.valueOf(
                type.name
            )
        }
    }
