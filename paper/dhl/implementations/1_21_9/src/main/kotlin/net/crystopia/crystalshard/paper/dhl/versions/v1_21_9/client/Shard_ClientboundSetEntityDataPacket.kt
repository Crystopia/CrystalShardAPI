...
import net.crystopia.crystalshard.paper.dhl.versions.v1_21_9.converter.data.merchant.build
import net.crystopia.crystalshard.paper.dhl.versions.v1_21_9.converter.enums.entities.EntityDataSerializerType
    ...
    fun buildMetaData(data: EntityMetadata<*>): SynchedEntityData.DataValue<*> {
        when (data.type) {
            ...
            net.crystopia.crystalshard.paper.dhl.shared.enums.entities.EntityDataSerializerType.HUMANOID_ARM -> {
                throw ClassNotFoundException("HUMANOID_ARM is not implemented in 1.21.9")
            }
