package net.crystopia.crystalshard.paper.dhl.versions.v1_21_9.client
...
import net.crystopia.crystalshard.paper.dhl.versions.v1_21_9.converter.data.particles.build
import net.crystopia.crystalshard.paper.dhl.versions.v1_21_9.converter.enums.particles.ParticleType
...
class Shard_ClientboundLevelParticlesPacket : IPacket<ClientboundLevelParticlesPacketData> {
    ...
    override fun createPacket(
        ...
        val particleData =
            if (packetObj.particle.options == null) net.crystopia.crystalshard.paper.dhl.versions.v1_21_9.converter.enums.particles.ParticleType.convert(
