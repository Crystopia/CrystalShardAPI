package net.crystopia.crystalshard.paper.dhl.versions.v1_21_9.converter.enums.gui
...
internal enum class MenuType(val type: MenuType<*>) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.paper.dhl.shared.enums.gui.MenuType): net.crystopia.crystalshard.paper.dhl.versions.v1_21_9.converter.enums.gui.MenuType {
