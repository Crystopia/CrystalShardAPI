package net.crystopia.crystalshard.paper.dhl.versions.v1_21_1.types.enums.gui
...
internal enum class MenuType(val type: MenuType<*>) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.paper.dhl.shared.enums.gui.MenuType): net.crystopia.crystalshard.paper.dhl.versions.v1_21_1.types.enums.gui.MenuType {
