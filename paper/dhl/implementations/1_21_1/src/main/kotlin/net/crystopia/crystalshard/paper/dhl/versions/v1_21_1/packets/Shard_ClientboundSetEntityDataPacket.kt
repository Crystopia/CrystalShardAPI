...
class Shard_ClientboundSetEntityDataPacket : IPacket<ClientboundSetEntityDataPacketData> {
    ...
    fun <T : Any> buildMetaData(data: EntityMetadata<T>): SynchedEntityData.DataValue<*> {
        val serializer = _root_ide_package_.net.crystopia.crystalshard.paper.dhl.versions.v1_21_1.converter.enums.entities.EntityDataSerializerType.convert(data.type).type as EntityDataSerializer<T>
