package net.crystopia.crystalshard.paper.dhl.versions.v1_21_1.converter.enums.scoreboard
...
enum class ObjectiveCriteria(val id: net.minecraft.world.scores.criteria.ObjectiveCriteria) {
    ...
    companion object {
        fun convert(type: net.crystopia.crystalshard.paper.dhl.shared.enums.scoreboard.ObjectiveCriteria): ObjectiveCriteria {
            return ObjectiveCriteria.valueOf(
                type.name
            )
        }
    }
