...
fun AdvancementBuilder.PAPER_1_21_10(added: MutableList<Advancement>): MutableMap<net.crystopia.crystalshard.dhl.shared.data.custom.NamespacedKey, net.minecraft.advancements.Advancement> {
