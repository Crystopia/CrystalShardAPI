...
fun AdvancementProgressBuilder.PAPER_1_21_10(progress: MutableMap<NamespacedKey, org.bukkit.advancement.AdvancementProgress>): MutableMap<net.crystopia.crystalshard.dhl.shared.data.custom.NamespacedKey, AdvancementProgress> {
    return progress.map {
