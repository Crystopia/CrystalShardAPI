...
import net.crystopia.crystalshard.dhl.versions.v1_21_11.server.Shard_ServerboundUseItemOnPacket
...
fun ServerPacketFactory.useItemOnEvent(
    ...
    when (ServerUtil.currentVersion()) {
        ...
        ServerVersion.v1_21_10 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_10.server.Shard_ServerboundUseItemOnPacket()
                .attach(data, callback)
        }

        ServerVersion.v1_21_9 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_9.server.Shard_ServerboundUseItemOnPacket()
                .attach(data, callback)
        }

        ServerVersion.v1_21_1 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_1.server.Shard_ServerboundUseItemOnPacket()
                .attach(data, callback)
        }
