...
import net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.ServerPacketBuilder
import net.crystopia.crystalshard.paper.dhl.utils.ServerUtil
import org.bukkit.craftbukkit.entity.CraftPlayer
import org.bukkit.entity.Player

fun ServerPacketFactory.seenAdvancementsEvent(
    player: Player,
    name: org.bukkit.NamespacedKey,
    shouldPublish: Boolean,
    callback: SeenAdvancementsEvent.() -> Unit
) {
    ...
    when (ServerUtil.currentVersion()) {
        ServerVersion.v1_21_11 -> {
            ServerPacketBuilder.seenAdvancementsEvent(
                data,
                callback
            )
        }
        ...
        ServerVersion.v1_21_10 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_10.builder.ServerPacketBuilder.seenAdvancementsEvent(
                data,
                callback
            )
        }
        ...
        ServerVersion.v1_21_9 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_9.builder.ServerPacketBuilder.seenAdvancementsEvent(
                data,
                callback
            )
        }
        ...
        ServerVersion.v1_21_1 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_1.builder.ServerPacketBuilder.seenAdvancementsEvent(
                data,
                callback
            )
        }
