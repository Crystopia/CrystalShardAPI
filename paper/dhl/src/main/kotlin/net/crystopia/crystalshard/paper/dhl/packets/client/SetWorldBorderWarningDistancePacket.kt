...
fun ClientPacketFactory.setWorldBorderWarningDistance(
    ...
    val packet = when (ServerUtil.currentVersion()) {
        ...
        ServerVersion.v1_21_10 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_10.builder.ClientPacketBuilder.setWorldBorderWarningDistance(
                data
            )
        }

        ServerVersion.v1_21_9 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_9.builder.ClientPacketBuilder.setWorldBorderWarningDistance(
                data
            )
        }

        ServerVersion.v1_21_1 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_1.builder.ClientPacketBuilder.setWorldBorderWarningDistance(
                data
            )
        }
