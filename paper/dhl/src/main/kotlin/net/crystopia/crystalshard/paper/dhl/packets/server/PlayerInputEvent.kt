...
fun ServerPacketFactory.playerInputEvent(
    ...
    when (ServerUtil.currentVersion()) {
        ServerVersion.v1_21_11 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_11.builder.ServerPacketBuilder.playerInputEvent(
                data,
                callback
            )
        }
        ...
        ServerVersion.v1_21_10 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_10.builder.ServerPacketBuilder.playerInputEvent(
                data,
                callback
            )
        }
        ...
        ServerVersion.v1_21_9 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_9.builder.ServerPacketBuilder.playerInputEvent(
                data,
                callback
            )
        }
        ...
        ServerVersion.v1_21_1 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_1.builder.ServerPacketBuilder.playerInputEvent(
                data,
                callback
            )
        }
