...
import net.crystopia.crystalshard.dhl.versions.v1_21_11.server.Shard_ServerboundInteractPacket
import org.bukkit.craftbukkit.entity.CraftPlayer

fun ServerPacketFactory.interactEvent(
    ...
    when (ServerUtil.currentVersion()) {
        ...
        ServerVersion.v1_21_10 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_10.general.ServerPacketBuilder.interactEvent(
                data,
                callback
            )
        }
        ...
        ServerVersion.v1_21_9 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_9.general.ServerPacketBuilder.interactEvent(
                data,
                callback
            )
        }
        ...
        ServerVersion.v1_21_1 -> {
            net.crystopia.crystalshard.dhl.versions.v1_21_1.general.ServerPacketBuilder.interactEvent(
                data,
                callback
            )
        }
