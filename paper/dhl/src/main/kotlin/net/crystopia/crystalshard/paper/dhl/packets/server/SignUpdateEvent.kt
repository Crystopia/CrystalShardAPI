...
fun ServerPacketFactory.signUpdateEvent(
    ...
    when (ServerUtil.currentVersion()) {
        ...
        ServerVersion.v1_21_10 -> {
            net.crystopia.crystalshard.paper.dhl.versions.v1_21_10.server.Shard_ServerboundSignUpdatePacket()
                .attach(data, callback)
        }

        ServerVersion.v1_21_9 -> {
            net.crystopia.crystalshard.paper.dhl.versions.v1_21_9.server.Shard_ServerboundSignUpdatePacket()
                .attach(data, callback)
        }
